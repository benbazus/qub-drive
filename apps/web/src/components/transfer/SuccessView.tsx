...
import { Link2, Check, Copy, Lock, Eye, BarChart3, Download } from 'lucide-react';
import { FileMetadata, AdvancedOptions, DownloadStats } from '../../types/transfer.types';
import { getFullShareLink, getExpirationDate } from '../../utils/formatters';
                ...
                <div className="p-8">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-6">
                        ...
                        <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                            ...
                            <p className="text-2xl font-bold text-gray-800">{totalSize}</p>
                        </div>
                        <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                            <p className="text-sm text-gray-600 mb-1">Expires</p>
                            <p className="text-lg font-semibold text-gray-800">
                                {getExpirationDate(advancedOptions.expirationDays)}
                            </p>
                        </div>
                        {advancedOptions.downloadLimit && (
                            <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                                <p className="text-sm text-gray-600 mb-1">Download Limit</p>
                                <p className="text-2xl font-bold text-gray-800">{advancedOptions.downloadLimit}</p>
                            </div>
                        )}
                    </div>
                    ...
                    {advancedOptions.enableTracking && stats && (
