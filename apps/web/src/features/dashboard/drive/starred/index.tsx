...
const StarredPage = () => {
    ...
    // 👇 Filter the files to only include those marked as starred
    const starredFiles = finalFilteredFiles.filter((file: { deleted: any; starred: any; }) => file.starred && !file.deleted)
    ...
    return (
        <DashboardLayout>
            ...
            <Card className="overflow-hidden">
                ...
                {starredFiles.length === 0 && !isLoadingFiles && ( // 👈 Use the new filtered array for the check
                ...
                <CardContent className='p-0'>
                    ...
                    {starredFiles.length === 0 && !isLoadingFiles && (
            ...
            <DialogManager dialogs={dialogs} closeDialog={closeDialog} files={starredFiles} />
        </DashboardLayout>
    );
};
