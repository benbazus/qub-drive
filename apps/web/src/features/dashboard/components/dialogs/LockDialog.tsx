...
export const useLockFile = () => {
    ...
    return useMutation({
        ...
        // We handle specific error messages in the component where we have more context.
    });
};
    ...
    const handleConfirmAction = () => {
        if (file.id) {
            ...
            lockMutation.mutate(
                ...
                {
                    onSuccess: () => {
                        // ADDED: Show a success toast for better user feedback.
                        toast.success(`File "${file.fileName}" has been ${actionPastTense}.`);
                        onClose(); // Close the dialog only on success.
                    },
                    // ADDED: Show an error toast if the mutation fails.
                    onError: (error) => {
            ...
            <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    <DialogTitle className="flex items-center gap-2">
                        ...
                        {file.locked ? `Unlock "${file.fileName}"` : `Lock "${file.fileName}"`}
                    </DialogTitle>
                ...
                <div className="space-y-6">
                    <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-3">
                        ...
                        <div className="text-sm text-gray-600 dark:text-gray-400 space-y-1">
                            <p><span className="font-medium">Name:</span> {file.fileName || "Unknown"}</p>
